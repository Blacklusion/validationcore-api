...
/**
 * Returns the AvailabilityPercentage for NodeWallet nodes
 * @param {string} guildName
 * @param {string} endpointUrl
 * @return {Promise<unknown>}
 */
export async function getAvailabilityNodeWallet(guildName: string, endpointUrl: string): Promise<unknown> {
