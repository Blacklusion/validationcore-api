...
/**
 * Returns the AvailabilityPercentage for NodeHyperion nodes
 * @param {string} guildName
 * @param {string} endpointUrl
 * @return {Promise<unknown>}
 */
export async function getAvailabilityNodeHyperion(guildName: string, endpointUrl: string): Promise<unknown> {
