...
/**
 * Returns the AvailabilityPercentage for NodeSeed nodes
 * @param {string} guildName
 * @param {string} endpointUrl
 * @return {Promise<unknown>}
 */
export async function getAvailabilityNodeSeed(guildName: string, endpointUrl: string): Promise<unknown> {
